...
/*Part of pulut hitam dish. Destroys burnt cooking pulut hitam when moving from pot to bowl
*/
public class burntCookingPulut : MonoBehaviour
{
    ...
    /* Destroys burnt cooking pulut hitam when moving from pot to bowl
    */
    void Update()
    {
